...
use UxGood\Bundle\FrameworkBundle\Controller\AbstractController;
use UxGood\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader;
use UxGood\Bundle\FullStack;
...
class FrameworkExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->registerForAutoconfiguration('UxGood\Bundle\FrameworkBundle\Controller\Controller')
            ->addTag('controller.service_arguments');
